import { MockData, TestCase } from '../types/testing.types';

export class TestUtils {
  static generateMockData(type: string): MockData {
  ...
  static extractFunctionSignature(code: string): Array<{
    name: string;
    params: string[];
    returnType?: string;
  }> {
  ...
  static generateTestCases(functionName: string, params: string[]): TestCase[] {
  ...
  static generateJestTemplate(functionName: string, testCases: TestCase[]): string {
  ...
  static identifyTestableUnits(code: string): string[] {
    const units: string[] = [];
  ...
  static generateAssertions(functionName: string, expectedType: string): string[] {
